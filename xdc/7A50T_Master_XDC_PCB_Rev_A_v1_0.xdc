...
# USB-UART - Bank 14
# ----------------------------------------------------------------------------
set_property -dict { PACKAGE_PIN M12   IOSTANDARD LVCMOS33 } [get_ports { uart_rx }];
set_property -dict { PACKAGE_PIN N6    IOSTANDARD LVCMOS33 } [get_ports { uart_tx }];
...
set_property -dict { PACKAGE_PIN N14   IOSTANDARD LVCMOS33 } [get_ports {clk_out_1        }];
set_property -dict { PACKAGE_PIN M16   IOSTANDARD LVCMOS33 } [get_ports {crs_dv_1         }];
set_property -dict { PACKAGE_PIN R16   IOSTANDARD LVCMOS33 } [get_ports {led_phy_1        }];
set_property -dict { PACKAGE_PIN N16   IOSTANDARD LVCMOS33 } [get_ports {mdc_1            }];
set_property -dict { PACKAGE_PIN P15   IOSTANDARD LVCMOS33 } [get_ports {mdio_1           }];
set_property -dict { PACKAGE_PIN P16   IOSTANDARD LVCMOS33 } [get_ports {clk_50_mhz_1       }];
set_property -dict { PACKAGE_PIN R15   IOSTANDARD LVCMOS33 } [get_ports {rst_n_1            }];
set_property -dict { PACKAGE_PIN L13   IOSTANDARD LVCMOS33 } [get_ports {rx_er_1          }];
set_property -dict { PACKAGE_PIN M14   IOSTANDARD LVCMOS33 } [get_ports {rx_d_1[0]        }];
set_property -dict { PACKAGE_PIN K13   IOSTANDARD LVCMOS33 } [get_ports {rx_d_1[1]        }];
set_property -dict { PACKAGE_PIN R13   IOSTANDARD LVCMOS33 } [get_ports {tx_d_1[0]        }];
set_property -dict { PACKAGE_PIN T12   IOSTANDARD LVCMOS33 } [get_ports {tx_d_1[1]        }];
set_property -dict { PACKAGE_PIN L14   IOSTANDARD LVCMOS33 } [get_ports {tx_e_1           }];

# ----------------------------------------------------------------------------
# PHY2 RMII - Bank 14
# ----------------------------------------------------------------------------

set_property -dict { PACKAGE_PIN N12   IOSTANDARD LVCMOS33 } [get_ports {clk_out_2        }];
set_property -dict { PACKAGE_PIN P11   IOSTANDARD LVCMOS33 } [get_ports {crs_dv_2         }];
set_property -dict { PACKAGE_PIN N9    IOSTANDARD LVCMOS33 } [get_ports {led_phy_2        }];
set_property -dict { PACKAGE_PIN R12   IOSTANDARD LVCMOS33 } [get_ports {mdc_2            }];
set_property -dict { PACKAGE_PIN T13   IOSTANDARD LVCMOS33 } [get_ports {mdio_2           }];
set_property -dict { PACKAGE_PIN R10   IOSTANDARD LVCMOS33 } [get_ports {clk_50_mhz_2       }];
set_property -dict { PACKAGE_PIN R11   IOSTANDARD LVCMOS33 } [get_ports {rst_n_2            }];
set_property -dict { PACKAGE_PIN P10   IOSTANDARD LVCMOS33 } [get_ports {rx_er_2          }];
set_property -dict { PACKAGE_PIN P14   IOSTANDARD LVCMOS33 } [get_ports {rx_d_2[0]        }];
set_property -dict { PACKAGE_PIN T14   IOSTANDARD LVCMOS33 } [get_ports {rx_d_2[1]        }];
set_property -dict { PACKAGE_PIN T15   IOSTANDARD LVCMOS33 } [get_ports {tx_d_2[0]        }];
set_property -dict { PACKAGE_PIN N13   IOSTANDARD LVCMOS33 } [get_ports {tx_d_2[1]        }];
set_property -dict { PACKAGE_PIN P13   IOSTANDARD LVCMOS33 } [get_ports {tx_e_2           }];
...
# ----------------------------------------------------------------------------
#set_property PACKAGE_PIN M5 [get_ports {reset_mii_to_rmii}];  # "M5.NetRP3_5"
...
# User LEDs - Bank 34
# ----------------------------------------------------------------------------
set_property -dict { PACKAGE_PIN L5   IOSTANDARD LVCMOS33 } [get_ports {led[0]     }];
set_property -dict { PACKAGE_PIN L4   IOSTANDARD LVCMOS33 } [get_ports {led[1]     }];
set_property -dict { PACKAGE_PIN M4   IOSTANDARD LVCMOS33 } [get_ports {led[2]     }];
set_property -dict { PACKAGE_PIN N3   IOSTANDARD LVCMOS33 } [get_ports {led[3]     }];
set_property -dict { PACKAGE_PIN N2   IOSTANDARD LVCMOS33 } [get_ports {led[4]     }];
set_property -dict { PACKAGE_PIN M2   IOSTANDARD LVCMOS33 } [get_ports {led[5]     }];
set_property -dict { PACKAGE_PIN N1   IOSTANDARD LVCMOS33 } [get_ports {led[6]     }];
set_property -dict { PACKAGE_PIN M1   IOSTANDARD LVCMOS33 } [get_ports {led[7]     }];
